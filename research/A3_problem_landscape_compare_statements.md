...
| **Data availability & access** | **High:** Legistar Web API (OData) [4], GeoHub Council Districts (2021) [5], 34 Community Plan Areas [6] [7], and LADBS Open Data [8]. | **Low:** LAHD Property Look-Up has only 5 fields [2]. NDSC housing violations data is aggregated to the census tract level (2005-2023) [9]. |
