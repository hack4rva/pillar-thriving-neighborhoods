# B5 Users Digital Equity Assessment
...
2. [Context & Definitions](#context--definitions) 
3. [Current Landscape of B5 Users](#current-landscape-of-b5-users) 
4. [National & International Digital Equity Initiatives](#national--international-digital-equity-initiatives) 
5. [Key Gaps & Barriers for B5 Users](#key-gaps--barriers-for-b5-users) 
...
B5 users—individuals and households enrolled in the Shared Equity (B5-5.3-01) program—remain disproportionately affected by the digital divide [1]. As of 2025, approximately 2.2 billion people worldwide lack meaningful internet connectivity [2]. In the United States, low-income households account for a significant portion of the offline population. Although the Affordable Connectivity Program (ACP) provided crucial support, it stopped accepting new enrollments on February 7, 2024, and officially ended its monthly discount on broadband services on June 1, 2024, due to a lack of congressional funding [3] [4]. Furthermore, the termination of the Digital Equity Act (DEA) grants on May 9, 2025, has severely constricted federal funding for digital inclusion efforts [5]. 

**Implications:** Without a coordinated replacement funding stream, B5 users risk falling further behind in education, health, and employment outcomes. 

**Action:** Stakeholders must align state-level digital equity capacity strategies with B5 eligibility criteria, leverage existing community broadband anchors, and implement rapid-deployment pilots for low-cost coverage in high-need areas by late 2026. 

--- 

## Context & Definitions

Understanding the intersection of housing affordability and digital access requires defining key programs and metrics that impact B5 households.
...
## Current Landscape of B5 Users

### Enrollment & Socio-Economic Profile

B5 users represent a critical demographic at the intersection of housing and digital vulnerability. These shared equity programs, often referred to as "below-market programs," impose maximum income limits to maintain long-term affordability [1]. Because these households are inherently income-constrained, they are highly sensitive to fluctuations in utility and connectivity costs. 

### Broadband Access Gaps

The digital divide remains starkly visible when analyzing connectivity quality and affordability. According to the International Telecommunication Union (ITU), while 5G networks are estimated to cover 55 percent of the world's population in 2025, coverage remains highly uneven, with 84 percent of people in high-income countries having access compared to only 4 percent in low-income countries [2]. 

| Connectivity Metric (2025) | Global High-Income Average | Global Low-Income Average |
|----------------------------|----------------------------|---------------------------|
| Internet Usage Rate | 94% | 23% |
| 5G Network Access | 84% | 4% |
| Urban vs. Rural Adoption | 85% (Urban) | 58% (Rural) |

*Takeaway:* The disparity in high-speed access directly impacts B5 users, particularly those in rural or historically underinvested urban areas, limiting their ability to participate in the digital economy [2].

### Impact of Federal Program Changes
...
## National & International Digital Equity Initiatives

### United States Federal Programs

The U.S. federal response to the digital divide has experienced severe contractions, leaving state and local entities to manage the fallout.

| Initiative | Status & Key Dates | Impact on Digital Equity |
|------------|--------------------|--------------------------|
| **Affordable Connectivity Program (FCC)** | Ended June 1, 2024 [3] | Removed critical monthly broadband subsidies for millions of low-income households, forcing consumers to absorb full market rates. |
| **Digital Equity Act (NTIA)** | Terminated May 9, 2025 [5] | Eliminated $1.44B in capacity grants and $60M in planning grants meant to help states address unique digital inclusion needs. |
| **High-Cost Area Benefit (FCC)** | Established August 4, 2023 [4] | Previously allowed up to a $75/month discount in NTIA-designated high-cost areas before the broader ACP wind-down. |

*Takeaway:* The simultaneous loss of direct consumer subsidies (ACP) and systemic infrastructure/skills funding (DEA) creates a compounding crisis for B5 households.
...
## Key Gaps & Barriers for B5 Users
...
To mitigate the severe impacts of recent federal funding cuts on B5 users, the following strategic actions are recommended:
