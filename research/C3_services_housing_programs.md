...
## Program Obligations: Affordability Rules and Terms

Each program carries distinct affordability conditions, rent limits, and income targeting requirements that must be tracked throughout the affordability period.

### Program-by-Program Affordability Conditions

| Program | Typical Rent Limits & Conditions | Income Targeting | Unit Set-Asides | Key Source |
| :--- | :--- | :--- | :--- | :--- |
| **HOME (Rental)** | HUD HOME rent limits; affirmative marketing required for projects >5 units. | 24 CFR Part 5 income definition. | Project-level HOME-assisted units. | [6] [2] |
| **CDBG** | Must meet Broad National Objectives (e.g., serving low- to moderate-income households). | Low/moderate income national objective. | N/A | [1] |
| **Section 108** | Mirrors CDBG national objectives; used for housing rehab and economic development. | Low/moderate income residents. | Project-specific. | [7] |
| **AHTF (Local)** | Annual compliance certifications required by January 15. | At least 30% of the fund must be used for households at or below 30% AMI. | As specified by the award agreement. | [8] [3] |
| **EDA AHPG** | As required by the specific grant agreement. | As required by the agreement. | Property-level commitments. | [4] |

*Takeaway:* Compliance tools must encode policy templates by program, as rules vary significantly between HUD's strict Part 5 income calculations and the AHTF's local AMI targeting mandates.

### Hidden Compliance Triggers
* **HOME 9-Month Conversion Rule:** New home construction and rehabilitation projects funded by HOME must be sold to an eligible homebuyer within nine months of completion. If there is no ratified sales contract within nine months, the unit must be converted to a rental unit subject to HOME rental requirements, or the funds must be repaid [2].
* **Affirmative Marketing:** The City requires all HOME applicants developing more than five units to submit and comply with affirmative marketing plans [6].
...
### Local Programs Monitoring Workflow
For the AHTF, recipients must submit certifications of compliance with all applicable affordability requirements in a form acceptable to HCD by January 15 of each year [8]. The EDA's AHPG requires recipients to comply with reporting requirements set forth in their specific agreements before receiving grant disbursements [4].

## Funding Landscape Shift: The New AHTF Dedication
...
### Section 108 in Richmond
The City actively repays a 2012 Section 108 Guaranteed Loan from HUD, which was earmarked for the rehabilitation of single-family homes, multi-family units, and economic development [7]. In FY2019, the City allocated $786,000 in CDBG funds for this repayment [7]. 

### Tax Increment Financing (TIF) Status
While the massive Navy Hill development project (which proposed an increment financing area and a 15% affordable housing requirement) was withdrawn by the City Council [12], future district financing efforts in the City Center will likely embed similar affordability obligations that will require monitoring.

## Building a Compliance Tool: Public vs. Private Data

A compliance monitoring tool can realistically use public sources to build an inventory, but must rely on private data for ongoing verification.

### What a Tool Could Realistically Use from Public Sources Alone
From public sources alone, a compliance tool can:
* **Map the Inventory:** Use HUD's LIHTC database, the National Housing Preservation Database (NHPD), and CPD Maps to identify subsidized properties and their locations [13] [14] [15].
* **Track Funding Flows:** Ingest federal CAPERs and Annual Action Plans to enumerate funded projects, Section 108 repayments, and program income uses [6] [7].
* **Identify Baseline Obligations:** Parse Legistar ordinances to identify AHTF grant awards and the new 2.5% tax dedication reporting requirements [11].

### Data That Must Be Solicited
To verify actual affordability, the tool must solicit private documents from developers/owners, including:
* Annual AHTF compliance certifications (due Jan 15) [8].
* Quarterly subrecipient reports [2].
* Tenant rent rolls and Part 5 income verification documents [2].
* Recorded restrictive covenants and deeds of trust.
...
* HOME-funded homebuyer units must be sold within nine months of completion, or they must be converted to rental housing under HOME rental requirements (http://rva.gov/sites/default/files/2020-08/PD-ProceduresManual2019-20.pdf) [2].
...
* Ordinance 2026-045 dedicates an amount equal to 2.5% of collected real estate taxes to the Affordable Housing Trust Fund (http://richmondva.legistar.com/ViewReport.ashx?Extra=WithText&GID=387&GUID=68BB35C1-7386-4022-B4B0-2002A554CAAC&ID=7873363&M=R&N=Master&Title=Legislation+Details+(With+Text)) [11].
...
### Unknowns
* The specific property-level affordability covenants and term lengths attached to the 2012 Section 108 loan projects are not detailed in the high-level Annual Action Plans.
* The exact affordability period lengths and unit set-asides for individual EDA Affordable Housing Performance Grants, which are governed by private grant agreements rather than public ordinances.
* The current, active HOME Rental Monitoring Schedule (the CAPER noted no units were due for inspection during the specific reporting period, but the full multi-year schedule is not published) [6].
...
2. *procedures manual for federal entitlement funds for fiscal ...*. https://www.rva.gov/sites/default/files/2020-08/PD-ProceduresManual2019-20.pdf
...
11. *Legislation Details (With Text) - ORD. 2026-045*. https://richmondva.legistar.com/ViewReport.ashx?M=R&N=Master&GID=387&ID=7873363&GUID=68BB35C1-7386-4022-B4B0-2002A554CAAC&Extra=WithText&Title=Legislation+Details+(With+Text)
12. *Legislation Text - RES. 2020-R009*. https://richmondva.legistar.com/ViewReport.ashx?M=R&N=Text&GID=387&ID=3816780&GUID=610AA619-BD67-4A7A-A4FC-523A62664600&Title=Legislation+Text
13. *Home - National Housing Preservation Database (NHPD)*. https://preservationdatabase.org/
14. *Low-Income Housing Tax Credit (LIHTC): Property Level Data | HUD USER*. https://www.huduser.gov/portal/datasets/lihtc/property.html
15. *CPD Maps*. https://egis.hud.gov/cpdmaps/
16. *Consolidated Planning/CHAS Data | HUD USER*. https://www.huduser.gov/portal/datasets/cp.html
17. *HUD's Community Assessment Reporting Tool (CART)*. https://egis.hud.gov/cart/
18. *Public Documents | Richmond*. https://www.rva.gov/housing-and-community-development/public-documents