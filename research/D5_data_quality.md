...
* **FMR Granularity**: Fair Market Rents (FMRs) are calculated for broad metropolitan and non-metropolitan areas. HUD updates these using regional CPI factors, which can diverge sharply from local realities (e.g., between 2013 and 2016, Austin's gross rent changed by 5.8% while the South region CPI factor was only 2.6%) [8].
...
* Richmond Legistar files have long lifecycles; for example, ORD. 2025—259 was created on 8/13/2025 and adopted on 2/23/2026. (https://richmondva.legistar.com/LegislationDetail.aspx?From=RSS&ID=7731683)
...
* HUD FMRs rely on regional CPI adjustments that can differ significantly from local rent changes (e.g., Austin 5.8% vs South region 2.6% from 2013 to 2016). (https://www.huduser.gov/portal/sites/default/files/pdf/Proposals-To-Update-the-Fair-Market-Rent-Formula.pdf)
...
### Unknowns
Several operational details remain undocumented, including Legistar's exact update latency SLA and historical "Location" field consistency, the specific spatial reference for all GeoHub layers, the exact refresh cadence of development layers, OCR geocoding success rates for older PDFs, and the full extent of NHPD coverage gaps for local preservation efforts.

## References

1. *GovData - Municipal Decision Dataset for AI Training, Grounding & Evaluation*. https://govdataconsulting.com/ai.html
2. *City of Richmond - File #: ORD. 2025—259*. https://richmondva.legistar.com/LegislationDetail.aspx?From=RSS&ID=7731683
3. *ORD. 2023—189 - Staff Report*. https://richmondva.legistar.com/gateway.aspx?M=F&ID=6111f717-e589-406d-9809-fefea10182bc.pdf
4. *ORD. 2025—252 - Staff Report*. https://richmondva.legistar.com/View.ashx?M=F&ID=14978174
