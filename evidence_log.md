...
| E-014 | HUD CHAS data is available at census tract level for Richmond | HUD CHAS download page | https://www.huduser.gov/portal/datasets/cp.html | Confirmed — census tract is an available geographic level in the download tool | 2026-03-18 |
...
|---|---|---|---|
| E-020-cv | Richmond Open Data Portal has an active building permits dataset | data.richmondgov.com does not expose a building permits dataset findable via API or search. The Socrata portal exists but building permits are not in the publicly indexed catalog. Richmond's permit portal is at rva.gov (Online Permit Portal), not the open data portal. | 2026-03-18 |
